  ...
  <main>
      <div class="container-fluid px-4">
          ...
          <div class="row">  <!-- row 1 -->
            ...
            $sql = "SELECT * FROM h_confirmed_case WHERE (Type_of_getting_vaccine = 'Pfizer1' OR Type_of_getting_vaccine = 'Pfizer2') AND Side_effects ='headache'";
        ...
        <?php
        $connection = mysqli_connect("localhost", "root", "admin", "covid19") or die("MySQL 접속 실패!!"); # 연결
        $sql = "SELECT * FROM p_clinical_trial WHERE (Type = 'Pfizer') AND Side_effects ='headache'";
        $ret = mysqli_query($connection, $sql);
