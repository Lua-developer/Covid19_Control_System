...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Lua World 아이템 드랍 조회</h1><br>
                <div class="card mb-4">
                    <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">메인 페이지</div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="txt_link" href="../home">메인 페이지</a>
                ...
                <div class="row">    <!-- row2 -->
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <canvas id="yu_graph1" width="100%" height="20"></canvas>
                        </div>
                    </div>
                </div>
                <div class="row">
                <!-- 컨텐츠 내용-->
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            $sql = "SELECT * FROM h_patient HS, h_hospitalization P WHERE (P.ID = HS.ID)";
                ...
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <form method="post" action="update.php">
                            ...
                            <div id="btn_update">
                            <button id = "update" button type ="submit"> 수정 </button><br>
                            </div>
                        </form>
                        <form method="post" action="delete.php">
                                <br><h3>삭제 할 환자의 주민등록번호를 기재해 주세요.</h3>
                                <br>주민등록번호 : <input type="text" name = "ID" maxlength="6">-
                                <input type="text" name = "ID2" maxlength="7"><br>
                                <div id="btn_delete">
                    ...
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <button type="button" onclick="location.href='temp2'">백신 이상증상 환자관리</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const yu1 = document.getElementById('yu1');
    if (yu1) {
        new simpleDatatables.DataTable(yu1);
    }
    });
</script>
...
<script>
    ...
    ///////////////// 나이대별 확진자 현황 //////////////////
    var yu_graph1 = document.getElementById("yu_graph1");
    var myPieChart1 = new Chart(yu_graph1, {
        type: 'pie',
        data: {
