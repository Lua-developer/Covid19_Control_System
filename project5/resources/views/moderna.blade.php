...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">모더나 백신 상황판</h1><br>
                <div class="card mb-4">
                    <div class="card-body">
                        국내 모더나 백신 관리 현황을 알려 드립니다.
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                        <?php
                            echo "<table id='m_table1'>";
                            $connection = mysqli_connect("localhost", "root", "admin", "covid19") or die("MySQL 접속 실패!!"); # 연결
                            $sql = "SELECT * FROM p_supply_vaccine WHERE Vaccine_type ='Moderna'";
...
<script>
    ...
    const m_table1 = document.getElementById('m_table1');
    if (m_table1) {
        new simpleDatatables.DataTable(m_table1);
    }
    });
</script>
</div>
