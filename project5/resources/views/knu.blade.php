...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">경북대병원 상황판</h1><br>
                <div class="card mb-4">
                    <div class="card-body">
                        2021 Covid 19 경북대병원의 현황을 안내 드립니다.
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">    <!-- row2 -->
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <canvas id="knu_graph1" width="100%" height="20"></canvas>
                        </div>
                    </div>
                </div>
                <div class="row">
                <!-- 컨텐츠 내용-->
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            $sql = "SELECT * FROM h_hospitalization HS, h_patient P WHERE (HS.ID = P.ID) AND HS.hopital='KH'";
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <button type="button" onclick="location.href='temp1'">백신 이상증상 환자관리</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const knu1 = document.getElementById('knu1');
    if (knu1) {
        new simpleDatatables.DataTable(knu1);
    }
    });
</script>
<script>
    window.addEventListener('DOMContentLoaded', event => {
    const knu2 = document.getElementById('knu2');
    if (knu2) {
        new simpleDatatables.DataTable(knu2);
    }
    });
</script>
<script>
    window.addEventListener('DOMContentLoaded', event => {
    const knu2 = document.getElementById('knu3');
    if (knu2) {
        new simpleDatatables.DataTable(knu2);
    }
    });
...
<script>
    ...
    ///////////////// 나이대별 확진자 현황 //////////////////
    var knu_graph1 = document.getElementById("knu_graph1");
    var myPieChart1 = new Chart(knu_graph1, {
        type: 'pie',
        data: {
